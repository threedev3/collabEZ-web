      ...
      >
        <CardSpotlight className=" relative sm:px-10 px-5 sm:py-10 py-5 h-[100vh] w-full -z-50">
          ...
          <div className="flex justify-center items-center relative h-full lg:z-[0] -z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[80vw] xl:max-w-[85vw] min-[1400px]:max-w-[70vw] flex flex-col min-[1400px]:gap-16 xl:gap-16 lg:gap-10 gap-6 items-center justify-center h-full">
              <TextGenerateEffect
