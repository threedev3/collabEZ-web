      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex flex-wrap space-x-1 text-white dark:hover:text-neutral-300 hover:text-heroColor transition-all duration-300"
            )}
          >
